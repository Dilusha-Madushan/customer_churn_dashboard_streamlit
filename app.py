...
# if not st.session_state['authentication_status'] and (not st.session_state['logout']):
#     authenticator = get_authenticator(authenticator)
#     name, authentication_status, username = authenticator.login(
#         "Login", "main")
# else:
#     name, authentication_status, username = st.session_state[
#         'name'], st.session_state['username'], True
...
if not authentication_status:
    ...
    with st.sidebar:
        # get_authenticator(authenticator).logout("Logout", "sidebar")
        # st.title(f"{name}")
